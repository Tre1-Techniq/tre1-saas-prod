...
const BannerDevLabAll = ({ title, navigation, parent, parentLink }: BannerProps) => {
  return (
    <>
      <section
            ...
            <div className="col-12 col-lg-7 col-xl-5">
              <div className="text-center text-lg-start">
                <p className="primary-text">
                  Industry Insights, Informative Tutorials & Helpful Tips.
                </p>
              </div>
            </div>
          </div>
...
export default BannerDevLabAll;
